CREATE DATABASE StudentSessionReportsLINQ;
GO
...
CREATE TABLE [SessionResults] (
  ...
  [TeacherFullName] nvarchar(255) not null,
  [DateOfPassing] date not null, 
  [Mark] int not null
)
GO

ALTER TABLE [Groups] ADD FOREIGN KEY ([SpecialtyId]) REFERENCES [Specialties] ([Id]) ON DELETE CASCADE
GO
