...
namespace FiguresLibrary.PlasticFigures
{
    ...
    /// A plastic circle
    /// </summary>
    public class PlasticCircle: PlasticSheet, ICircle
    {
        public int Diameter { get; set; }
        public int Radius { get; set; }

        /// <summary>
        /// Inits a new plastic circle.
        /// </summary>
        /// <param name="radius"></param>
        public PlasticCircle(int radius)
        {
            Radius = radius;
            Diameter = 2 * radius;
        }
        ...
        /// <summary>
        /// Returns a plastic circle from another.
        /// </summary>
        /// <param name="radius"></param>
        /// <param name="figure"></param>
        public PlasticCircle(int radius, IFigure figure)
        {
        ...
        {
            return obj is PlasticCircle circle &&
                   base.Equals(obj) &&
                   color == circle.color &&
